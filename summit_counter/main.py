...
_SUMMITS = [
    ('Austin', 'Austin',
     'https://wiki.openstack.org/wiki/Design_Summit/Austin'),
    ('Bexar', 'San Antonio',
     'https://wiki.openstack.org/wiki/Design_Summit/Bexar'),
    ('Cactus', 'Santa Clara', ''),
    ('Diablo', '', ''),
    ('Essex', 'Boston', 'https://wiki.openstack.org/wiki/Design_Summit/Essex'),
    ('Folsom', 'San Francisco',
     'https://wiki.openstack.org/wiki/Design_Summit/Folsom'),
    ('Grizzly', 'San Diego',
     'https://wiki.openstack.org/wiki/Design_Summit/Grizzly'),
    ('Havana', 'Portland',
     'https://wiki.openstack.org/wiki/Design_Summit/Havana'),
    ('Icehouse', 'Hong Kong',
     'https://wiki.openstack.org/wiki/Design_Summit/Icehouse'),
    ('Juno', 'Atlanta', 'https://wiki.openstack.org/wiki/Design_Summit/Juno'),
    ('Kilo', 'Paris', 'https://wiki.openstack.org/wiki/Design_Summit/Kilo'),
    ('Liberty', 'Vancouver',
     'https://wiki.openstack.org/wiki/Design_Summit/Liberty'),
